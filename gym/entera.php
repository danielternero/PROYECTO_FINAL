...
$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('22222222A', 'ALVARO', 'GARRIDO SOTO', '2016-05-25', 25, 64, '', 'alvaro', 'alvaro@gmail.com', '98db6b79acb71383b5a83e0bbc1cadd4', 1, NULL);");

$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('00000000X', 'PRUEBA', 'PRUEBA1 PRUEBA2', '2016-05-28', 0, 0, '', 'PRUEBA', 'PRUEBA@PRUBA.COM', '3614f7b8bf42dbb37b040c9387ddc1f0', 1, NULL);");

$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('345678901', 'SANDRA', 'JIMENEZ LOPEZ', '2016-05-31', 42, 67, '', 'sandra', 'sandrita@gmail.com', '24a9e2777be9a0ff42ed59b90deeb5a5', 1, NULL);");

$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('55555555A', 'RAMON', 'SANCHEZ PIZJUAN', '2016-05-31', 51, 88, '', 'ramon', 'ramon@gmail.com', '266575d3c2b8a34f83817458f96152b1', 1, NULL);");

$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('99999999A', 'ISABEL', 'ESPINA MARMOL', '2016-05-31', 31, 56, '', 'isabel', 'isa@gmail.com', '4b2fb63731e470a4911460210170abaa', 1, NULL);");

$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('66666666A', 'PEPE', 'SANTOS GOMARA', '2016-05-31', 26, 76, '', 'pepe', 'pepe@gmail.com', '926e27eecdbc7a18858b3798ba99bddd', 1, NULL);");

$connection->query("INSERT INTO `usuario` (`DNI`, `NOMBRE`, `APELLIDO`, `FECHA_ALTA`, `EDAD`, `PESO`, `ENFERMEDAD`, `USUARIO`, `CORREO_ELECTRONICO`, `CONTRASENA`, `NIVEL_DE_USUARIO`, `IMAGEN_PERSONAL`) VALUES
('00000000A', 'ROSA', 'MUNOZ LEPE', '2016-05-31', 38, 90, '', 'rosa', 'rosa@gmail.com', '84109ae4b4178430b8174b1dfef9162b', 1, NULL);");
